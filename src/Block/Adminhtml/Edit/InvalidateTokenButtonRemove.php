...
/**
 * Class InvalidateTokenButtonRemove
 */
class InvalidateTokenButtonRemove extends \Magento\Customer\Block\Adminhtml\Edit\InvalidateTokenButton implements ButtonProviderInterface
{
    /**
     * @return array
     */
